...
$stmt2 = $mysqli->prepare("SELECT k.nama_kategori FROM buku_kategori bk JOIN kategori k ON bk.id_kategori = k.id_kategori WHERE bk.id_buku = ?");
...
$data = [
    ...
    "kategori"      => $kategori,
    "cover"         => "http://localhost/perpustakaan/uploads/users/" . $buku['cover_buku']
];
