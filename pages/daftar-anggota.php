                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="d-flex align-item-center">
                                ...
                                <?php else : ?>
                                    <div style="width: 60px; height: 80px; background:#ddd; border-radius: 5px; margin-right: 10px; display: flex; align-items: center; justify-content: center; color: #999;">No <br> Cover</div>
                                <?php endif ?>
                                <div>
